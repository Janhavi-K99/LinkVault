...
import { useArchivedLinks, useFolders, useUIStore } from '@/store/useStore'
  ...
  return (
    <div>
      ...
      {sorted.length > 0 ? (
        ...
        <EmptyState icon={Archive} title="Archive is empty" description="Archived links will appear here" />
      )}
